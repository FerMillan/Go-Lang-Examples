...
//func Connection() {
//	ctx := context.Background()
//	db, err := sql.Open("mysql", "saldogra_naveen:gyns22M2km8B@tcp(sandbox.cpi0yoqzrjqz.us-west-1.rds.amazonaws.com)/saldogra_sandbox?parseTime=true")
//	if err != nil {
//		log.Fatal(err)
//	}
//
...
//	// qm.Select is a "query mod" and is used to modify the query
//	userP, err := models.TBLUsers(
//		qm.Select("name", "email", "mobile"), // The args do jack shit, the model brings every column anyways
//	).One(ctx, db)
//	if err != nil {
//		log.Fatal(err)
//	}
...
//	// number of them (since the model's argument is a slice).
//	tblUser2, err := models.TBLUsers(
//		qm.Where("email = ?", "vikram@undostres.com.mx"), // There is also WhereIn
//	).One(ctx, db)
//	if err != nil {
//		log.Fatal(err)
//	}
